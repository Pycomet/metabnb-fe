...
const IndexPage = () => {
    ...
    return (
        <div>
            ...
            <div className="flex md:flex-row bg-[#A02276] justify-center py-2 ">
                <img className="lg:px-40 md:px-10 py-1 icon" src={MbToken} alt="token" />
                <img className="lg:px-40 md:px-10 py-1 icon" src={Meta} alt="token" />
                <img className="lg:px-40 md:px-10 py-1 icon" src={Opensea} alt="token" />
            </div>
            ...
            <div className="bg-[#A02276] py-2 font-redrose">
                <div className="container mx-auto max-w-[80%] my-2 md:justify-between flex lg:flex-row flex-col" >
                    <div className="lg:w-2/5 text-left text-[26px] text-white md:text-6xl lg:my-40  my-10 font-semibold flex-col">
                    ...
                    <div className="lg:w-3/5 lg:my-20 mb-10 md:ml-[6em]">
